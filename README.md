...
> now available as a [GitHub Marketplace action](https://github.com/marketplace/actions/hypercubesphere-release)

> works with node, deno and python

[![Commits](https://img.shields.io/github/commit-activity/w/HyperCubeSphere/release?style=flat)](https://github.com/HyperCubeSphere/release/pulse)
[![Issues](https://img.shields.io/github/issues/HyperCubeSphere/release.svg?style=flat)](https://github.com/HyperCubeSphere/release/issues)
[![Releases](https://img.shields.io/github/v/release/HyperCubeSphere/release.svg?style=flat)](https://github.com/HyperCubeSphere/release/releases)
...
jobs:
  release:
    ...
    steps:
      ...
      - name: "🚀 release"
        id: semantic-release
        uses: docker://ghcr.io/hypercubesphere/release:1.0.0
        env:
...
jobs:
  release:
    ...
    steps:
      ...
      - name: "🚀 release"
        id: semantic-release
        uses: HyperCubeSphere/release@v1
        env:
          GITHUB_TOKEN: ${{ secrets.GITHUB_TOKEN }}
          NPM_TOKEN: ${{ secrets.NPM_TOKEN }}
...
- `GIT_COMMITTER_NAME="hypercubesphere[bot]"`
- `GIT_COMMITTER_EMAIL="279296405+hypercubesphere[bot]@users.noreply.github.com"`
